...
import { getNotificationsForEachContainer, getNotificationsForMobileView, prepareNotification } from './utils';
import {
  StyledAlerts,
...
import { mediaBreakpoints } from 'components/_themes/constants';
