...
const LogIn = () => {
  return (
    <>
      <Grid direction="column" alignItems="center">
        ...
        <Item size={12}>
          <Block padding="xs" margin="xs">
            <InputText leftIcon={true} typeIcon="iconUser" label={labels.input_labels.login} />
          </Block>
        </Item>
        <Item size={12}>
      ...
      <Item size={12}>
        <Block>
          <InputCheckbox>{labels.input_labels.agreement}</InputCheckbox>
        </Block>
      </Item>
      <Item size={12}>
        <Block padding="xs" margin="xs">
